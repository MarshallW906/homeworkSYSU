...
/**
 * user guide
 * can compute the md5 by using the funtion ComputMd5
 * eg:
 *     MD5 m;
 ...
 *     m.printMd5();
 *
 *  if you want to compute segment by segment, you can do as follow, and init() is suggested
 *  the beginning, and Finalize() must call in the end:
 *
 *      MD5 M;
 *      m.init();
