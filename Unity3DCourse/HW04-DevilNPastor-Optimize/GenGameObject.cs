...
public class GenGameObject : MonoBehaviour
{
	...
	Vector3 leftBoatPos = new Vector3(0, 1.8f, -1.2f);
	Vector3 rightBoatPos = new Vector3(0, 1.8f, 1.2f);
...
//		setCharacterPositions (devils_start, devilStartPos);
//		setCharacterPositions (devils_end, devilEndPos);
//		setPositions was moved to a Function and is called each time a Move completed.
		check ();
	}
